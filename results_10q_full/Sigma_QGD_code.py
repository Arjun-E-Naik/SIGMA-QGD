...
class CostEvaluator:
    ...
    def cost_and_gradient(self, theta: np.ndarray) -> Tuple[float, np.ndarray]:
        """
         GPU: energy + full gradient in ONE batched call (2p+1 circuits).
        """
        p = len(theta)
    ...
    def statevector(self, theta: np.ndarray) -> np.ndarray:
        """ get the raw statevector (used by Diag-QNG for sv_base).
...
# ===================================================================
# CLI (unchanged, minus the qiskit-only --hamiltonian-format specifics)
# ===================================================================
